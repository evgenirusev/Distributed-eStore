...
var ProductListComponent = function (_a) {
...
exports.ProductList = react_redux_1.connect(function (state) { return state.products; }, products_1.actionCreators)(ProductListComponent);
