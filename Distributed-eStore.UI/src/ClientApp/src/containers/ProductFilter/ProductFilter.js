...
var ProductFilterComponent = function (_a) {
    ...
    return React.createElement("div", { className: "product-filter row" },
        React.createElement("button", { onClick: requestProductsFemale }, "Women's Sale"),
        React.createElement("button", { onClick: requestProductsMale }, "Men's Sale"),
        React.createElement("button", { onClick: requestProductsAccessories }, "Bags & Accessories Sale"));
};
