...
var _1 = require(".");
var createOrder_1 = require("../../services/api/createOrder");
exports.actionCreators = {
    ...
    removeAllProductsFromCart: function () { return function (dispatch, getState) {
        Object.keys(getState().cart.productIdToCartProductMap).forEach(function (productId) {
            dispatch({
                type: _1.CartActionTypes.REMOVE_FROM_CART,
                productId: productId
            });
    ...
    placeOrder: function (order) { return function (dispatch, getState) { return __awaiter(void 0, void 0, void 0, function () {
        var error_1, message;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, createOrder_1.createOrder(order)];
                case 1:
                    _a.sent();
                    dispatch({
                        type: _1.CartActionTypes.CHANGE_QUANTITY,
